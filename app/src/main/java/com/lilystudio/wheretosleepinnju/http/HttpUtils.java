...
public class HttpUtils {
    ...
    public void login(final String schoolUrl, final String xh, String passwd, String catpcha,
        ...
        OkHttpUtils.post().url(schoolUrl+Url.LoginUrl)
            ...
            @Override
            public void onResponse(String response, int id){
                LoginUrl.e(this,response);

                if(response.contains(app.mContent.getString(R.string.catpcha_err))){
                    callback.onFail(app.mContent.getString(R.string.catpcha_err);)
                }else if(response.contains(app.mContent.getString(R.string.pwd_err))){
                    callback.onFail(app.mContent.getString(R.string.pwd_err));
                }else if(response.contains(app.mContent.getString(R.string.timeout_err))){
                    callback.onFail(app.mContent.getString(R.string.timeout_err));
                }else{
